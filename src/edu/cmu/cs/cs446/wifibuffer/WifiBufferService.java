...
public class WifiBufferService extends Service {
   ...
   */
  RemoteCallbackList<IWifiBufferServiceCallback> mCallbacks = new RemoteCallbackList<IWifiBufferServiceCallback>();
  ...
  public IBinder onBind(Intent intent) {
    ...
    // the Intent.
    if (IWifiBufferService.class.getName().equals(intent.getAction())) {
      return mBinder;
    }
  ...
  public static class Controller extends Activity {
    ...
    private OnClickListener mStartListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        // the service.
        startService(new Intent("edu.cmu.cs.cs214.wifibuffer.REMOTE_SERVICE"));
      }
    };
    ...
    private OnClickListener mStopListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        // still bound clients.
        stopService(new Intent("edu.cmu.cs.cs214.wifibuffer.REMOTE_SERVICE"));
      }
    };
  }
  ...
  public static class Binding extends Activity {
    ...
    IWifiBufferService mService = null;
     ...
     */
    private IWifiBufferServiceCallback mCallback = new IWifiBufferServiceCallback.Stub() {
      /**
  ...
  public static class BindingOptions extends Activity {
    ...
    private OnClickListener mBindNotForegroundListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        ServiceConnection conn = new MyServiceConnection();
        Intent intent = new Intent(IWifiBufferService.class.getName());
        if (bindService(intent, conn, Context.BIND_AUTO_CREATE | Context.BIND_NOT_FOREGROUND)) {
          mCurConnection = conn;
        }
      }
    };
    ...
    private OnClickListener mBindAboveClientListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        ServiceConnection conn = new MyServiceConnection();
        Intent intent = new Intent(IWifiBufferService.class.getName());
        if (bindService(intent, conn, Context.BIND_AUTO_CREATE | Context.BIND_ABOVE_CLIENT)) {
          mCurConnection = conn;
        }
      }
    };
    ...
    private OnClickListener mBindAllowOomListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        ServiceConnection conn = new MyServiceConnection();
        Intent intent = new Intent(IWifiBufferService.class.getName());
        if (bindService(intent, conn, Context.BIND_AUTO_CREATE | Context.BIND_ALLOW_OOM_MANAGEMENT)) {
          mCurConnection = conn;
        }
      }
    };
    ...
    private OnClickListener mBindWaivePriorityListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        Intent intent = new Intent(IWifiBufferService.class.getName());
        if (bindService(intent, conn, Context.BIND_AUTO_CREATE | Context.BIND_WAIVE_PRIORITY)) {
          mCurConnection = conn;
        }
      }
    };
    ...
    private OnClickListener mBindImportantListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        ServiceConnection conn = new MyServiceConnection();
        Intent intent = new Intent(IWifiBufferService.class.getName());
        if (bindService(intent, conn, Context.BIND_AUTO_CREATE | Context.BIND_IMPORTANT)) {
          mCurConnection = conn;
        }
      }
    };
    ...
    private OnClickListener mBindWithActivityListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        ServiceConnection conn = new MyServiceConnection();
        Intent intent = new Intent(IWifiBufferService.class.getName());
        if (bindService(intent, conn, Context.BIND_AUTO_CREATE | Context.BIND_ADJUST_WITH_ACTIVITY
